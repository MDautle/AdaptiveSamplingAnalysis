...
This repository is associated with the following manuscript:  Dautle, M., Warren, M., Roman, E., Gould, A. (2026) Evaluating Adaptive Sampling Performance for Low-Diversity Whole-Genome Sequencing Using a Binary Vertebrate-Bacteria Symbiosis. (Under Review)
...
| [downsample_basesSequenced.py](./downsample_basesSequenced.py) | The script used to downsample bases for methylation analysis. It is not required to run the Jupyter notebook, but is required to create some of the input files used in the analysis for Figure 3. | 
